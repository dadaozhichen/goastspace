...
goastspace_Linux: /lib64/ld-linux-x86-64.so.2 \
  ...
  /usr/local/lib/libSDL3.so.0.4.10 \
  /usr/local/lib/libSDL3_image.so.0.4.4 \
  /usr/local/lib/libSDL3_mixer.so.0.2.4 \
  /usr/local/lib/libSDL3_ttf.so.0.2.2 \
